      ...
      <div className="overflow-hidden rounded-[16px] bg-[#ECE5D8]">
        ...
        <div className="flex items-center gap-2 bg-teal px-3 py-2">
          ...
          <div className="min-w-0 text-left">
            <div className="truncate font-display text-[10px] font-bold text-white">{storeName}</div>
            <div className="font-mono text-[7px] text-white/70">{statusLabel}</div>
          </div>
        </div>
        ...
        <div className="p-2.5">
          <div className="rounded-[10px] rounded-tl-sm border-2 border-ink bg-white p-2 shadow-brand">
            ...
            <div className="mt-1.5 flex items-center justify-end gap-1">
              <span className="font-mono text-[7px] text-ink/40">{timeLabel}</span>
